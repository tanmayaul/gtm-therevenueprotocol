...
- `videos.json`: sixteen recording scripts, including upfront-payment wording.
...
Verified: desktop and 375px mobile rendering; all fifteen video FAQ cards and text answers; welcome script and upfront wording; dialog Escape and focus return; calendar previews; deck navigation; no horizontal overflow; no browser console errors.
